...
exp_name = 'bam_list_' + locus_name + \
			'_'+str(1)+'_cov'+str(coverage)+\
			'_dist'+str(dist_mean)+'_DIP_readLen_' + str(read_len)

# copy_list = [1,3,5,7,10,12,15,20,25,30,40,50,60,70,80,90,100,120,150]
# copy_list = [12, 20, 40, 80, 100]
copy_list = [3,7,10,15,25,30,35,40,45,50,60,80, 100, 120, 150, 180, 210]
###################
...
if align_flag == 'True':
	for nc1 in copy_list:
		for nc2 in copy_list:

...
ref_genome='/storage/nmmsv/toy_example/pipeline/fa/hg38_HTT.fa'
bed_dir='/storage/nmmsv/toy_example/pipeline/fa/region/'
repo_dir = '/storage/nmmsv/str-expansions/'
base_dir = '/storage/nmmsv/toy_example/experiments/'
run_dir = "/storage/nmmsv/analysis/GangSTR-analyses/simulation/"

loc_info = {}
loc_info['HTT'] = {'chrom': 'chr1',\
                   'start': 100000,\
                   'end': 100056,\
                   'motif_len': 3,\
                   'motif': 'CAG',\
                   'copy_list1': [9,19,29],\
                   'copy_list2': [19, 29, 39, 49, 59, 69]}
###################
coverage = 40
diploid = 'True'
number = 1
...
exp_name = 'toyExample_'+str(number) + \
           '_cov'+str(coverage)+\
